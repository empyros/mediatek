...
#if defined(ACER_C11_GC)
	GC2035_write_cmos_sensor(0xc1 , 0x38);// //3c//D -light
#else
...
#if defined(ACER_C11_GC)
	GC2035_write_cmos_sensor(0xc4 , 0x05);//ec  
#else
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
#if defined(ACER_C11_GC)
			GC2035_write_cmos_sensor(0x13,0x74);  // 0x68   zyx : 0x78/0x80  78  84
#else
