...
//#define OV5647MIPI_USE_LENC_OTP   //ov5647t no lens calibration data  //copy form OV5650 LENC OTP

#define RG_TYPICAL 0x57  //golden sample R/G ratio
#define BG_TYPICAL 0x5C  //golden sample B/G ratio
