...
/*---------------------------------OTP CODE START-------------------------------------------------*/
#if defined(ACER_C11)||defined(PHILIPS_W6500)||defined(PHILIPS_STAMFORD)|| defined(PHILIPS_ROYAL2)
#define OTP_SUPPORT
#endif
...
#define OTP_MID               0x01	//for Sunny P8V06AA module
#else
