...
#define S5K5CAGX_MANUAL_ANTI_FLICKER
#endif
...
void S5K5CAGX_Initialize_Setting(void)
{
	...
	*/
	...
	// CWF
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01E4); //01C8#TVAR_wbt_pBaseCcms[54]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF6C); //FF7F#TVAR_wbt_pBaseCcms[55]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDA); //FFE4#TVAR_wbt_pBaseCcms[56]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF56); //FF64#TVAR_wbt_pBaseCcms[57]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D2); //01B2#TVAR_wbt_pBaseCcms[58]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF22); //FF35#TVAR_wbt_pBaseCcms[59]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFD1); //FFDF#TVAR_wbt_pBaseCcms[60]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDD); //FFE9#TVAR_wbt_pBaseCcms[61]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D6); //01BD#TVAR_wbt_pBaseCcms[62]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0110); //011C#TVAR_wbt_pBaseCcms[63]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0110); //011B#TVAR_wbt_pBaseCcms[64]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF59); //FF43#TVAR_wbt_pBaseCcms[65]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA); //019D#TVAR_wbt_pBaseCcms[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF2B); //FF4C#TVAR_wbt_pBaseCcms[67]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01DF); //01CC#TVAR_wbt_pBaseCcms[68]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF16); //FF33#TVAR_wbt_pBaseCcms[69]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0185); //0173#TVAR_wbt_pBaseCcms[70]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x013A); //012F#TVAR_wbt_pBaseCcms[71]
	// D50
...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[0]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFCE); //#TVAR_afit_pBaseVals[3]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[45]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[104]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFCE); //#TVAR_afit_pBaseVals[107]
...
#if defined(SIMCOM_FOR1T)
		case AE_EV_COMP_10:                
			S5K5CAGX_write_cmos_sensor(0x0F12, 0x0020);  // EV1
		break;
#else
		case AE_EV_COMP_10:                
