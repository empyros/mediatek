...
*/
static DEVICE_ATTR(ftstpfwver, S_IRUGO | S_IWUGO, fts_tpfwver_show,
			fts_tpfwver_store);

/*upgrade from *.i
*example: echo 1 > ftsfwupdate
*/
static DEVICE_ATTR(ftsfwupdate, S_IRUGO | S_IWUGO, fts_fwupdate_show,
			fts_fwupdate_store);
...
*/
static DEVICE_ATTR(ftstprwreg, S_IRUGO | S_IWUGO, fts_tprwreg_show,
			fts_tprwreg_store);
...
*/
static DEVICE_ATTR(ftsfwupgradeapp, S_IRUGO | S_IWUGO, fts_fwupgradeapp_show,
