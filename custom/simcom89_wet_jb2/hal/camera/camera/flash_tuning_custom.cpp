...
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
...
#if defined(PHILIPS_STAMFORD)||defined(PHILIPS_W6500)
	para.dutyNum = 32;
#else
...
#elif  defined(PHILIPS_W6500)
	para.engLevel.pfDuty = 31;
	para.engLevel.mfDutyMax = 31;
	para.engLevel.mfDutyMin = 31;
...
#elif  defined(PHILIPS_W6500)
	para.engLevel.pfDutyL = 31;
	para.engLevel.mfDutyMaxL = 31;
	para.engLevel.mfDutyMinL = 31;
	para.engLevel.pmfStepL = 0;
#elif defined(PHILIPS_STAMFORD)
	para.engLevel.pfDutyL = 4;
...
#if defined(PHILIPS_STAMFORD)
	para.coolTimeOutPara.tabId[1]=1;//5;
	para.coolTimeOutPara.tabId[2]=7;//8;
	para.coolTimeOutPara.tabId[3]=8;//12;
	para.coolTimeOutPara.tabId[4]=25;//16;
	para.coolTimeOutPara.tabId[5]=31;//20;
	para.coolTimeOutPara.coolingTM[0]=0;
	para.coolTimeOutPara.coolingTM[1]=0;
	para.coolTimeOutPara.coolingTM[2]=2;//3;
	para.coolTimeOutPara.coolingTM[3]=4;//5;
	...
	para.coolTimeOutPara.timOutMs[2]=100;//1000;
	para.coolTimeOutPara.timOutMs[3]=100;//400;
	para.coolTimeOutPara.timOutMs[4]=500;//400;
	para.coolTimeOutPara.timOutMs[5]=500;//400;
#else
