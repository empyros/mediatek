...
#if defined(ACER_C11)||defined(SIMCOM_FOR1T)||defined(PHILIPS_W6500)||defined(PHILIPS_STAMFORD)
...
#if defined(ACER_C11)|| defined(SIMCOM_FOR1T)||defined(PHILIPS_W6500)||defined(PHILIPS_STAMFORD) ||defined(PHILIPS_ROYAL2)
#else
#if defined(CUSTOM_KERNEL_ALSPS)
	retval = platform_device_register(&sensor_alsps);
		printk("sensor_alsps device!");
